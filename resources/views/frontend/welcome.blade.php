							...
							<div class="products-slick" data-nav="#slick-nav-2">
								...
								<div class="product">
									...
									<div class="product-body">
										...
										<h4 class="product-price"><a href="{{url('/view-details/'.$topProduct->id)}}">&#2547;{{$topProduct->price}} <del class="product-old-price">&#2547;{{$product->price}}</del></a></h4>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
